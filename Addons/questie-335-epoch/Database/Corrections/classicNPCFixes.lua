...
function QuestieNPCFixes:Load()
    ...
    return {
        ...
        [4845] = { -- Shadowforge Ruffian
            [npcKeys.zoneID] = zoneIDs.BADLANDS,
            [npcKeys.spawns] = {[zoneIDs.BADLANDS]={{44.4,12.4},{44.6,12.4},{45,11},{45.2,12.8},{45.4,10.2},{45.6,11.4},{45.6,12.8},{46.4,12.2},{46.4,13.6},{46.8,13.4},{47.2,12},{47.4,10.8},{47.4,13.6},{47.6,13.8},{47.8,13},{48,9},{48,10.8},{48,12.4},{48.2,35.8},{48.8,13.8},{49,12.4},{49.2,13},{49.4,10.2},{49.8,12.4},{50,9.8},{50,12.8},{50.2,33.4},{50.4,15},{50.6,14.8},{50.8,13.2},{51.2,12.4},{51.2,14.2},{51.2,27.2},{51.6,15.4},{51.8,18.8},{52.2,27.6},{52.4,21.6},{52.4,26.6},{52.6,15.6},{52.8,18.8},{53.2,18.2},{54.4,21.2},{55,17}}},
        },
        ...
        [7937] = { -- High Tinker Mekkatorque <King of Gnomes> (the waypoints in the wotlkDB file are valid only during BREWFEST event)
        ...
        [8917] = { -- Quarry Slave (Quarry Slave (not inside BRD, but at the entrance and this is the best way to show him, since there is no map for inside Blackrock Mountain))
        ...
        [10182] = { -- Rexxar <Champion of the Horde>
        ...
        [12576] = { -- Grish Longrunner (Add spawn in The Barrens to be shown on the map)
            [npcKeys.spawns] = {
        ...
        [14305] = { -- Human Orphan (default zone where you start the chain) (only SW for consistency)
