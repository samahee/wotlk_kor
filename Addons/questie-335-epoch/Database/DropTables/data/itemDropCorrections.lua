...
local DropKeys = DropDB.correctionKeys
  ...
  -- For instance, if you put the above example into Era corrections, but loaded up Wotlk, it would show Wotlk Wowhead data,
  -- regardless of whatever data exists in the Wotlk pserver DB.
