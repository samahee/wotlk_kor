...
local iconOptionsLocales = {
    ...
    ["When this is enabled, trivial repeatable quests will be shown on the map/minimap."] = {
        ["ptBR"] = "Quando isso estiver ativado, os locais das missões repetíveis triviais serão mostrados no mapa/minimapa.",
        ["ruRU"] = "Показать/скрыть местоположения тривиальных повторяемых заданий на карте мира и миникарте",
        ["deDE"] = "Aktiviert/Deaktiviert die Icons von trivialen wiederholbaren Quests auf der Karte/Minimap.",
        ["koKR"] = "이 아이콘을 활성화하면 지도/미니맵에 하찮은 반복 퀘스트 위치가 표시됩니다.",
        ["esMX"] = "Cuando está habilitado la localización de misiones repetibles triviales mostrará en el mapa y minimapa.",
        ["enUS"] = true,
        ["zhCN"] = "启用此功能后，低等级重复任务的位置将显示在 世界地图/小地图上。",
        ["zhTW"] = "啟用時，會在大地圖和小地圖上顯示低等級可重覆接取的任務。",
        ["esES"] = "Cuando está habilitado la localización de misiones repetibles triviales mostrará en el mapa y minimapa.",
        ["frFR"] = "Active l'affichage des quêtes répétables triviales sur la carte et la minicarte.",
    },
