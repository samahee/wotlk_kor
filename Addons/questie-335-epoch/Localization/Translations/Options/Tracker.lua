...
local trackerOptionsLocales = {
    ...
    ["Hide In Combat"] = {
        ["enUS"] = true,
        ["deDE"] = "Im Kampf ausblenden",
        ["esES"] = "Ocultar en combate",
        ["esMX"] = "Ocultar en combate",
        ["frFR"] = "Cacher en combat",
        ["koKR"] = "전투 중 숨기기",
        ["ptBR"] = "Ocultar em combate",
        ["ruRU"] = "Скрывать в бою",
        ["zhCN"] = "在战斗中隐藏",
        ["zhTW"] = "戰鬥中隱藏",
    },
    ["If checked, the Questie Tracker will automatically be hidden when entering combat."] = {
        ...
        ["esES"] = "Si está seleccionado, el rastreador se ocultará automáticamente al entrar en combate.",
        ["esMX"] = "Si está seleccionado, el rastreador se ocultará automáticamente al entrar en combate.",
        ["frFR"] = "Si cette option est cochée, le suivi sera automatiquement caché lors des combats.",
    ...
    ["Hide In Dungeons"] = {
        ...
        ["esMX"] = "Ocultar en calabozos",
        ["frFR"] = "Cacher dans les donjons",
        ["koKR"] = "던전에서 숨기기",
    ...
    ["If checked, the Questie Tracker will automatically be hidden when entering a dungeon."] = {
        ...
        ["esES"] = "Si está seleccionado, el rastreador se ocultará automáticamente al entrar a una mazmorra.",
        ["esMX"] = "Si está seleccionado, el rastreador se ocultará automáticamente al entrar a un calabozo.",
        ["frFR"] = "Si cette option est cochée, le suivi sera automatiquement caché lors de l’entrée dans un donjon.",
    ...
    ["Tracker Width Ratio"] = {
        ["enUS"] = true,
        ["deDE"] = "Tracker Breitenverhältnis",
        ["esES"] = "Relación de anchura del rastreador",
        ["esMX"] = "Relación de anchura del rastreador",
        ["frFR"] = "Ratio de largeur du suivi",
        ["koKR"] = "추적기 너비 비율",
    ...
    ["The width of the Questie Tracker based on percentage of usable screen width. A setting of 100 percent would make the Tracker fill the players entire screen width.\n\nNOTE: This setting only applies while in Sizer Mode: Auto"] = {
        ["enUS"] = true,
        ["deDE"] = "Die Breite des Questie-Trackers basierend auf dem Prozentsatz der nutzbaren Bildschirmbreite. Eine Einstellung von 100 Prozent würde den Tracker die gesamte Bildschirmbreite des Spielers ausfüllen lassen.\n\nHINWEIS: Diese Einstellung gilt nur im Sizer-Modus: Auto",
        ["esES"] = "La anchura del rastreador se basa en el porcentaje de la anchura utilizable de la pantalla. Una configuración de 100 por ciento haría que el rastreador llenará toda la anchura de la pantalla del jugador.\n\nNOTA: Esta configuración solo se aplica en el Modo de medición: Automático.",
        ["esMX"] = "La anchura del rastreador se basa en el porcentaje de la anchura utilizable de la pantalla. Una configuración de 100 por ciento haría que el rastreador llenará toda la anchura de la pantalla del jugador.\n\nNOTA: Esta configuración solo se aplica en el Modo de medición: Automático.",
        ["frFR"] = "La largeur du suivi en pourcentage de la largeur d'écran utilisable. Un réglage de 100 pour cent ferait remplir la largeur de l'écran du joueur.\n\nREMARQUE : Ce réglage ne s'applique que lors du Mode de calibrage : Automatique.",
