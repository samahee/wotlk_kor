...
local socialOptionsLocales = {
    ...
    ["Objective progress"] = {
        ...
        ["ruRU"] = "Прогресс цели",
        ["deDE"] = "Questzielfortschritt",
        ["koKR"] = false,
        ["esMX"] = "Progreso de objetivo",
        ["enUS"] = true,
        ["zhCN"] = "目标进度",
        ["zhTW"] = "任務目標進度",
        ["esES"] = "Progreso de objetivo",
    ...
    ["Announce objective progress to other players"] = {
        ["ptBR"] = "Anunciar o progresso do objetivo para outros jogadores",
        ["ruRU"] = "Оповещение о прогрессе цели задания",
        ["deDE"] = "Teilt den Fortschritt von Questzielen anderen Spielern mit.",
        ["koKR"] = false,
        ["esMX"] = "Anunciar el progreso del objetivo a otros jugadores.",
        ["enUS"] = true,
        ["zhCN"] = "向其他玩家通报目标进度",
        ["zhTW"] = "任務目標進度時向其他玩家通報",
        ["esES"] = "Anunciar el progreso del objetivo a otros jugadores.",
        ["frFR"] = "Annoncer la progression des objectifs aux autres joueurs",
    },
    ["Quest completed"] = {
