...
local searchLocales = {
    ...
    ["This Object Also Completes the following quests:"] = {
        ["enUS"] = true,
        ["deDE"] = "Dieses Objekt beendet außerdem die folgenden Quests:",
        ["esES"] = "Este objeto también finaliza las siguientes misiones:",
        ["esMX"] = "Este objeto también finaliza las siguientes misiones:",
        ["frFR"] = "Cet objet permet également de terminer les quêtes suivantes :",
    ...
    ["Quest Start Item Information"] = {
        ["enUS"] = true,
        ["deDE"] = "Quest-Start-Gegenstand-Informationen",
        ["esES"] = "Artículo que inicia la misión",
        ["esMX"] = "Información del artículo que inicia la misión",
        ["frFR"] = "Informations sur l'objet débutant la quête",
        ["koKR"] = "퀘스트 시작 아이템 정보",
        ["ptBR"] = "Informação sobre o item que começa a missão",
        ["ruRU"] = "Информация о начинающем задание предмете",
        ["zhCN"] = "任务起始物品信息",
        ["zhTW"] = "任務開始物品資訊",
    },
    ...
    ["Quest Turn-in Object Information"] = {
        ["enUS"] = true,
        ["deDE"] = "Quest-Abgabe-Objekt-Informationen",
        ["esES"] = "Información del objeto al que se entrega la misión",
        ["esMX"] = "Información del objeto al que se entrega la misión",
        ["frFR"] = "Informations sur l'objet terminant la quête",
        ["koKR"] = "퀘스트 완료 오브젝트 정보",
        ["ptBR"] = "Informação sobre o objeto de entrega da missão",
        ["ruRU"] = "Информация о завершающем задание объекте:",
        ["zhCN"] = "任务提交物体信息",
        ["zhTW"] = "交回任務物體資訊",
    },
