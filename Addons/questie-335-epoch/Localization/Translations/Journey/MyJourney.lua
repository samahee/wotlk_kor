...
local myJourneyLocales = {
    ...
    ["Disabling quest already turned in"] = {
        ["enUS"] = true,
        ["deDE"] = "Deaktivierende Quest ist bereits abgegeben",
        ["esES"] = "Desactivando misión ya entregada",
        ["esMX"] = "Desactivando misión ya entregada",
        ["frFR"] = "Désactive la quête déjà rendue",
    ...
    ["Enabling quest not active nor turned in"] = {
        ...
        ["esES"] = "Activando misión no activa ni entregada",
        ["esMX"] = "Activando misión no activa ni entregada",
        ["frFR"] = "Active la quête ni active ni rendue",
