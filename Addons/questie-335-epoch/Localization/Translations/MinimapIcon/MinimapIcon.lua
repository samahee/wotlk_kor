...
local minimapIconLocales = {
    ...
    ["Dungeon Locations"] = {
        ["ptBR"] = "Localizações de Masmorras",
        ["ruRU"] = "Места подземелий",
        ["deDE"] = "Dungeon-Standorte",
        ["koKR"] = "던전 위치",
        ["esMX"] = "Ubicaciones de calabozos",
        ["enUS"] = true,
        ["zhCN"] = "地下城位置",
        ["zhTW"] = "地下城位置",
        ["esES"] = "Ubicaciones de mazmorras",
        ["frFR"] = "Emplacements des donjons",
    },
    ["Raid Locations"] = {
        ["ptBR"] = "Localizações de Raides",
        ["ruRU"] = "Места рейдов",
        ["deDE"] = "Schlachtzug-Standorte",
        ["koKR"] = "레이드 위치",
        ["esMX"] = "Ubicaciones de bandas",
        ["enUS"] = true,
        ["zhCN"] = "团队位置",
        ["zhTW"] = "團隊位置",
        ["esES"] = "Ubicaciones de bandas",
        ["frFR"] = "Emplacements des raids",
    },
    ["Instances"] = {
        ["ptBR"] = "Instâncias",
